<div class="container">
  <h2>Notas
    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#exampleModal">Crear Nota</button>
  </h2>
</div>
{{-- no es necesario especificar el metodo POST con este formulario --}}
